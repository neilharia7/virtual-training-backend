    ...
    $.fn.zenith = function (options) {
            ...
            thumbs: function () {
                ...
                if (settings.fixedThumbs === true) {
                    ...
                    if (settings.navPosition === 'bottom') {
                        ...
                        $('#' + ID + ' ' + settings.markup[0]).hover(function () {
                            $(chg).animate({marginBottom: 0}, 350)
                        }, function () {
                            $(chg).animate({marginBottom: -padding + 'px'}, 350)
                        })
                    } else if (settings.navPosition === 'top') {
                        $(chg).css('margin-top', -padding + 'px');
                        $('#' + ID + ' ' + settings.markup[0]).hover(function () {
                            $(chg).animate({marginTop: 0}, 350)
                        }, function () {
                            $(chg).animate({marginTop: -padding + 'px'}, 350)
                        })
                    } else if (settings.navPosition === 'left') {
                        $(chg).css('margin-left', -padding + 'px');
                        $('#' + ID + ' ' + settings.markup[0]).hover(function () {
                            $(chg).animate({marginLeft: 0}, 350)
                        }, function () {
                            $(chg).animate({marginLeft: -padding + 'px'}, 350)
                        })
                    } else if (settings.navPosition === 'right') {
                        $(chg).css('margin-right', -padding + 'px');
                        $('#' + ID + ' ' + settings.markup[0]).hover(function () {
                            $(chg).animate({marginRight: 0}, 350)
                        }, function () {
                            $(chg).animate({marginRight: -padding + 'px'}, 350)
                        })
                    }
                }
            }//thumbs;
       ...
       =================================*/
        if (settings.layout === 'default') {
            ...
            if (settings.autoplay === true) {
                zis.find('.highlight').hover(function () {
                    clearInterval(play)
                }, function () {
                    play = setInterval(autoplay.first, parseInt(settings.autoplaySpeed));
                });
            }
          ...
          =================================*/
            ...
            if (settings.autoplay === true) {
                zis.find('.highlight').hover(function () {
                    ...
                    play = setInterval(autoplay.second, parseInt(settings.autoplaySpeed));
                });
            }
          ...
          =================================*/
            ...
            if (settings.autoplayPause === true && settings.autoplay === true) {
                zis.find('#mac-screen').hover(function () {
                    clearInterval(play)
                }, function () {
          ...
          =================================*/
            ...
            //pause autoplay on hover
            if (settings.autoplayPause === true && settings.autoplay === true) {
                parent.find(settings.markup[0]).hover(function () {
                    clearInterval(play)
                }, function () {
                    play = setInterval(autoplay.third, parseInt(settings.autoplaySpeed));
                });
