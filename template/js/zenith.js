          ...
          var i;
           ...
           if( settings.autoplay === true ){
           	...
           	for (i=0; i < settings.data.length; i++){
           		 var play = setTimeout(autoplay.third, parseInt( settings.data[i].time) * 1000); 
             	console.log( i + " " + settings.data[i].time);
           	}
           ...
           // if( settings.autoplay === true ){
           //   var play = setTimeout(autoplay.third, parseInt(1000) ); 
           //   console.log("1000")
           //   var play = setTimeout(autoplay.third, parseInt( 2000) ); 


           //   var play = setTimeout(autoplay.third, parseInt( 3000) ); 


           //   var play = setTimeout(autoplay.third, parseInt( 4000) ); 
           // }
